...
- Now go to your browser and access your server’s domain name or IP address on port `8008`: `http://server_domain_or_IP:8008`. In case you are running this demo on your local machine, use `http://localhost:8008` to access the application from your browser.
